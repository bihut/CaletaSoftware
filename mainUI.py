...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.startRecording.setCheckable(True)
        ...
        self.enableCamera.setCheckable(True)
        self.enableCamera.setObjectName("enableCamera")
        self.gridLayout.addWidget(self.enableCamera, 0, 0, 1, 1)
        self.videoContent = QtWidgets.QLabel(self.centralwidget)
        self.videoContent.setText("")
        self.videoContent.setObjectName("videoContent")
        self.gridLayout.addWidget(self.videoContent, 1, 0, 1, 3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.enableCamera.setText(_translate("MainWindow", "Start Camera"))
